    ...
    (<div className={styles['dashboard']}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap' }}>
        {issues.length > 0 ? (
            ...
            {(rowsPerPage > 0
              ...
              >
                <div className={styles['list-book-details-container']}>
                  <p>
                    <span className={styles['item-span']}>Student ID: </span>
                    {`${issue.student._id}`}
                  </p>
                  <p>
                    <span className={styles['item-span']}>Student Email: </span>
                    {`${issue.student.email}`}
                  </p>
                  <p>
          ...
          <h2 className={styles['nobooks-errormsg']}>No Books are Issued</h2>
        )}
      </div>
